 ...
 * Hotbar + Ruestung + Offhand) zur Vorschau. Read-only; unten ein Button
 * zum Bestaetigen und einer zum Zurueckgehen.
 *
 * targetUuid != null bedeutet Admin-Modus (Wiederherstellen fuer einen
 * anderen Spieler). targetUuid == null heisst: aktiver Spieler.
 */
